// I:\Log Register\client\src\frontend\Dashboard.jsx
...
const Dashboard = () => {
  ...
  const menuItems = [
    {
      title: 'Student Marks',
      description: 'Manage and view student marks and academic performance',
      icon: (
    ...
    {
      title: 'Reports',
      description: 'Generate and view comprehensive student reports',
      icon: (
            ...
            >
              <div className="bg-white rounded-xl shadow-sm hover:shadow-md border border-gray-100 overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="inline-flex items-center text-${item.color}-600 hover:text-${item.color}-700">
