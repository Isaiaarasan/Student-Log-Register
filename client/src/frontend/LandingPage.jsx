          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">Log Register</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-indigo-600">Academic Records</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Efficiently manage student attendance, marks, and reports in one centralized platform. 
              Designed for educational institutions that value organization and efficiency.
            </p>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Everything you need to manage academic records</h2>
            <p className="mt-4 text-lg text-gray-500">
              Comprehensive tools to streamline your educational institution's record-keeping process
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Simple and secure student registration process with unique roll numbers',
                icon: (
              ...
              },
              {
                ...
                description: 'Record and analyze student performance across different subjects and exams',
                icon: (
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; {new Date().getFullYear()} Log Register. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
